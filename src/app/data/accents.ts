...
export const ACCENTS: Record<ProjectAccent, AccentStyle> = {
  pink: {
    ...
    text: 'text-pink-400',
    iconBg: 'bg-zinc-800 text-pink-400',
    pill: 'bg-pink-400/10 text-pink-400 border-pink-400/20',
  ...
  cyan: {
    ...
    text: 'text-cyan-400',
    iconBg: 'bg-zinc-800 text-cyan-400',
  ...
  emerald: {
    ...
    iconBg: 'bg-zinc-800 text-emerald-400',
  ...
  sky: {
    ...
    text: 'text-sky-400',
    iconBg: 'bg-zinc-800 text-sky-400',
  ...
  purple: {
    ...
    iconBg: 'bg-zinc-800 text-purple-400',
  ...
  green: {
    ...
    text: 'text-green-400',
    iconBg: 'bg-zinc-800 text-green-400',
